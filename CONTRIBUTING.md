...
3. Increase the version numbers in any examples files and the [ruby gem version](lib/adventure/version.rb) file to the new version that this Pull Request would represent. The versioning scheme we use is [SemVer](http://semver.org/).
